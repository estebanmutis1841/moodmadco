    ...
    function templateMenu(items) {
        ...
        for(let item in items.menu) {
            if (items.menu.hasOwnProperty(item)) {
                listItems += `<li class="redirect-mobile" data-menuanchor=${item}><a href="#${item}">${items.menu[item]}</a></li>`;
            }
        }
